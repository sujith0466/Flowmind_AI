...
const navItems = [
  ...
  { label: 'Workflow', href: '#orchestration' },
];
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-full overflow-hidden">
      <motion.div
        ...
        className="absolute left-1/2 top-[-25rem] h-[55rem] w-full max-w-[78rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(59,130,246,0.15),rgba(99,102,241,0.08)_38%,transparent_66%)] blur-[100px]"
      />
      <motion.div
        animate={{ x: [0, 20, 0], y: [0, 10, 0] }}
        transition={{ duration: 14, repeat: Infinity, ease: 'easeInOut' }}
        className="absolute right-[-10%] top-[15rem] h-[45rem] w-[45rem] rounded-full bg-[radial-gradient(circle,rgba(168,85,247,0.12),transparent_66%)] blur-[90px]"
      />
      <motion.div
        animate={{ x: [0, -20, 0], y: [0, 10, 0] }}
        transition={{ duration: 13, repeat: Infinity, ease: 'easeInOut' }}
        className="absolute left-[-10%] top-[15rem] h-[45rem] w-[45rem] rounded-full bg-[radial-gradient(circle,rgba(34,211,238,0.1),transparent_66%)] blur-[90px]"
      />
...
function FloatingNavbar() {
  return (
    ...
    >
      <nav className="flex w-full max-w-[980px] min-w-0 items-center justify-between gap-3 rounded-full bg-[#03050d]/70 px-3 py-2 shadow-[inset_0_1px_1px_rgba(255,255,255,0.06),0_24px_100px_rgba(0,0,0,0.6)] ring-1 ring-white/[0.08] backdrop-blur-3xl">
...
function HeroSection() {
  return (
    <PageSection id="hero" className="flex min-h-[calc(100vh-6rem)] flex-col items-center justify-center py-24 text-center lg:py-28">
      <motion.div animate={{ y: [0, -6, 0] }} transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut' }} className="flex w-full flex-col items-center">
        <motion.div variants={stagger} initial="hidden" animate="visible" className="flex w-full flex-col items-center">
        <motion.div variants={fadeUp} transition={{ duration: 0.65, ease }} className="mb-7 inline-flex max-w-full items-center gap-2 rounded-full bg-white/[0.055] px-3.5 py-2 text-xs font-semibold text-white/68 ring-1 ring-white/[0.09] backdrop-blur-2xl">
        ...
        <motion.div variants={fadeUp} transition={{ duration: 0.72, ease }} className="mt-12 flex w-full max-w-2xl flex-col gap-3 sm:flex-row sm:justify-center">
          {['Research', 'Plan', 'Execute'].map((item, index) => (
            <div key={item} className="flex min-w-0 items-center justify-center gap-2 rounded-full bg-white/[0.03] px-4 py-2.5 text-sm font-semibold text-white/54 ring-1 ring-white/[0.05] backdrop-blur-xl">
...
function AgentNode({ agent, index }) {
  ...
  return (
    <motion.div
      ...
      className={`absolute z-30 hidden w-[13.75rem] max-w-full rounded-[1.65rem] bg-[#050811]/85 p-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.06),0_24px_90px_rgba(0,0,0,0.44)] ring-1 ring-white/[0.06] backdrop-blur-3xl sm:block ${agent.className}`}
    >
    ...
    <PageSection id="orchestration" className="pb-24 lg:pb-32">
      <div className="relative mx-auto w-full max-w-[1180px] min-w-0">
        ...
        <motion.div
          ...
          className="relative min-w-0 overflow-hidden rounded-[2.8rem] bg-white/[0.025] p-3 shadow-[inset_0_1px_1px_rgba(255,255,255,0.06),0_20px_60px_rgba(0,0,0,0.4)] ring-1 ring-white/[0.06] backdrop-blur-3xl"
        >
